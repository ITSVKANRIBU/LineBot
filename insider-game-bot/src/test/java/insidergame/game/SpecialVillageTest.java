...
import static insidergame.testing.Texts.repeat;
...
public class SpecialVillageTest {
  ...
  public void werewordsMessagesStayDeliverableWithALongTopic() {
    ...
    List<String> messages = new CreateWereWordsLogic(new CreateVillage(new SpecialVillageRegistry())).getMessages(true, 3, longTopic);
